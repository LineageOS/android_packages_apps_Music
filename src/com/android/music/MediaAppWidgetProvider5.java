...
public class MediaAppWidgetProvider5 extends AppWidgetProvider {
    ...
    public static Bitmap getReflection(Bitmap bitmap){
        ...
        Bitmap reflect = Bitmap.createBitmap(bitmap, 0, 
                bmheight/2, bmwidth, bmheight/2, matrix, false);
    ...
    private void defaultAppWidget(Context context, int[] appWidgetIds) {
        ...
        Bitmap noart =  BitmapFactory.decodeStream(
                context.getResources().openRawResource(R.drawable.albumart_mp_unknown),
                null, opts);
    ...
    void performUpdate(MediaPlaybackService service, int[] appWidgetIds) {
        ...
        opts.inPreferredConfig = Bitmap.Config.ARGB_8888;
        Bitmap noart =  BitmapFactory.decodeStream(
                service.getResources().openRawResource(R.drawable.albumart_mp_unknown),
                null, opts);
