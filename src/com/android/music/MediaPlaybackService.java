...
public class MediaPlaybackService extends Service {
    ...
    public void onCreate() {
	    ...
	    PendingIntent mediaPendingIntent = PendingIntent.getBroadcast(getApplicationContext(), 0, mediaButtonIntent, PendingIntent.FLAG_UPDATE_CURRENT);
    ...
    public void play() {
        ...
        if (mPlayer.isInitialized()) {
            ...
            Intent mediaButtonIntent = new Intent(Intent.ACTION_MEDIA_BUTTON);
            mediaButtonIntent.putExtra("notifToggle", true);
            mediaButtonIntent.setComponent(rec);
            ...
            PendingIntent mediaPendingIntent = PendingIntent.getBroadcast(getApplicationContext(), 1, mediaButtonIntent, PendingIntent.FLAG_UPDATE_CURRENT);
            ...
            mediaButtonIntent.putExtra(Intent.EXTRA_KEY_EVENT, mediaKey);
            mediaPendingIntent = PendingIntent.getBroadcast(getApplicationContext(), 2, mediaButtonIntent, PendingIntent.FLAG_UPDATE_CURRENT);
    ...
    private void gotoIdleState() {
        ...
        mDelayedStopHandler.sendMessageDelayed(msg, IDLE_DELAY);
        stopForeground(false);
        status.contentView.setImageViewResource(R.id.play, isPlaying() ? R.drawable.ic_appwidget_music_play : R.drawable.ic_appwidget_music_pause);
