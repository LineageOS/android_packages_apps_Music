...
public class MediaPlaybackActivity extends Activity implements MusicUtils.Defs,
    ...
    private boolean mHasGesturesEnabledChanged = false;
    ...
    private void loadGestureLibrary() {
        ...
        editor.remove(MusicSettingsActivity.KEY_STALE_GESTURES);
    }
    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
        if (key.equals(MusicSettingsActivity.KEY_ENABLE_GESTURES)) {
            mHasGesturesEnabledChanged = true;
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent intent) {
        ...
        switch (requestCode) {
            case NEW_PLAYLIST:
                ...
                break;
            case SETTINGS:
                if (mHasGesturesEnabledChanged) {
                    mHasGesturesEnabledChanged = false;
                    mAlbumArtWorker.quit();
                    configureActivity();
                } else if (mPreferences.getBoolean(MusicSettingsActivity.KEY_STALE_GESTURES,
                        false)) {
                    loadGestureLibrary();
                }
                break;
